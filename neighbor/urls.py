...
urlpatterns = [
    ...
    url(r'^view/business/$', views.view_business, name='view_business'),
    url(r'^view/business/(?P<id>\d+)/$', views.one_business, name='one_business'),
    ...
    url(r'^view/(?P<id>\d+)/delete/', views.delete_neighborhood, name='delete_neighborhood'),
